  ...
  return (
    <form onSubmit={handleSearch} className="relative flex-1 max-w-md">
      ...
      <input
        ...
        value={searchTerm}
        className="w-full py-1.5 pl-10 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-500 shadow-md shadow-accent-500 placeholder:text-primary-50/70 placeholder:text-sm bg-primary-950 text-accent-200 font-semibold"
        onChange={(e) => {
