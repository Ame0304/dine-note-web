...
export default function Loading({
  ...
  // Size configurations for the SVG
  const svgSizes = {
    small: "w-6 h-6",
    medium: "w-10 h-10",
    large: "w-16 h-16",
    ...
    <div className={`${containerClasses} ${className}`}>
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="flex items-center justify-center">
          <svg
            className={`text-primary-900 animate-spin ${svgSizes[size]}`}
            viewBox="0 0 64 64"
            fill="none"
          ...
          >
            ...
            <path
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className={`text-accent-500 ${strokeWidths[size]}`}
            ></path>
          </svg>
        </div>
