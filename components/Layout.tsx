...
export default function Layout({
  ...
  return (
    <div className=" antialiased flex flex-col relative min-h-screen">
      {isSharePage ? (
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-primary-900/50 backdrop-blur-lg backdrop-saturate-150 supports-[backdrop-filter]:bg-primary-950">
          <nav
            aria-label="Global"
